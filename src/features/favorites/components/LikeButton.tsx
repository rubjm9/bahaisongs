        ...
        >
          {isLiked ? (
            <svg width={20} height={20} viewBox="0 0 24 24" aria-hidden>
              <defs>
                <linearGradient id="bs-fav-heart-grad" x1="0%" y1="0%" x2="100%" y2="100%">
              ...
              <path
                ...
                fill="url(#bs-fav-heart-grad)"
                stroke="url(#bs-fav-heart-grad)"
                strokeWidth="0.75"
                style={{ filter: `drop-shadow(0 0 8px ${accent.cyan}88)` }}
              />
            </svg>
          ) : (
            <Heart size={20} fill="none" strokeWidth={2} />
          )}
        </IconButton>
      </span>
    </Tooltip>
