...
> = {
  'comunidad-bahai': {
    ...
    bio: {
      ...
      it: "Musica, preghiere e composizioni nate nella comunità bahá'í — un repertorio comunitario che include canti per riunioni, preghiere cantate, testi sacri e brani per le classi di bambini e giovani.",
      ...
      hu: "Zene, imák és kompozíciók a bahá'í közösségből — közösségi repertoár: gyűlési dalok, énekelt imák, szent szövegek, valamint gyermek- és ifjúsági osztályok darabjai.",
      ...
      zh: "来自巴哈伊群体内部的音乐、祷文与作品——涵盖聚会歌曲、歌唱祷文、圣文以及儿童与青年课程曲目的共同曲库。",
      hi: "बहाई समुदाय के भीतर से संगीत, प्रार्थनाएँ और रचनाएँ — सामुदायिक संग्रह जिसमें सभा गीत, गायी गई प्रार्थनाएँ, पवित्र पाठ तथा बच्चों और युवाओं की कक्षाओं के लिए रचनाएँ शामिल हैं।",
      sw: "Muziki, sala na nyimbo kutoka ndani ya jamii ya Kibahá'í — hazina ya pamoja inayojumuisha nyimbo za mikusanyiko, sala zinazoimbwa, maandiko matakatifu na vipande kwa madarasa ya watoto na vijana.",
